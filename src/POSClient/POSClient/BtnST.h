...
public:
	...
	static HBITMAP CreateDarkerBitmap(HBITMAP hBitmap, DWORD dwWidth, DWORD dwHeight, COLORREF crTrans);
	void SizeToContent();
...
protected:
	...
	int			m_bIsCheckBox;		// 1Is the button a checkbox?  4 radio button

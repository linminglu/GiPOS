...
public:
	CBarcode();
	void	LoadData(CStringA csMessage, double dNarrowBar, double dFinalHeight, HDC pDC, int nStartingXPixel, int nStartingYPixel, double dRatio = 1.0);

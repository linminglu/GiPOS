...
enum {USER_NAME_LEN=0,MAX_TABLE_NUM,MAX_ITEM_QUANTITY,MAX_ITEM_WEIGHT,MAX_GUEST_NUM,PREORDER_WARNING_HOUR
		,EXIT_AFTER_SEND,PRINT_TRANS,EXIT_AFTER_PAY,HEAD_BEGIN_ID,COMBINE_ONE_CHECK,ROUND_ITEM_TTLPRICE,PRINT_CHECK};
